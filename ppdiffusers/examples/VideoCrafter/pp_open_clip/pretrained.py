...
_VITB32_256 = dict(datacomp_s34b_b86k=_pcfg(hf_hub="laion/CLIP-ViT-B-32-256x256-DataComp-s34B-b86K/"))
_VITB16 = dict(
    openai=_pcfg(
...
_VITH14_378_quickgelu = dict(
    dfn5b=_pcfg(hf_hub="apple/DFN5B-CLIP-ViT-H-14-378/", interpolation="bicubic", resize_mode="squash")
)
_VITg14 = dict(
...
_convnext_base = dict(laion400m_s13b_b51k=_pcfg(hf_hub="laion/CLIP-convnext_base-laion400M-s13B-b51K/"))
...
_PRETRAINED = {
    ...
    "EVA01-g-14": dict(laion400m_s11b_b41k=_pcfg(hf_hub="timm/eva_giant_patch14_clip_224.laion400m_s11b_b41k/")),
    "EVA01-g-14-plus": dict(
        merged2b_s11b_b114k=_pcfg(hf_hub="timm/eva_giant_patch14_plus_clip_224.merged2b_s11b_b114k/")
    ),
    "EVA02-B-16": dict(merged2b_s8b_b131k=_pcfg(hf_hub="timm/eva02_base_patch16_clip_224.merged2b_s8b_b131k/")),
    "EVA02-L-14": dict(merged2b_s4b_b131k=_pcfg(hf_hub="timm/eva02_large_patch14_clip_224.merged2b_s4b_b131k/")),
    "EVA02-L-14-336": dict(merged2b_s6b_b61k=_pcfg(hf_hub="timm/eva02_large_patch14_clip_336.merged2b_s6b_b61k/")),
    "EVA02-E-14": dict(laion2b_s4b_b115k=_pcfg(hf_hub="timm/eva02_enormous_patch14_clip_224.laion2b_s4b_b115k/")),
...
def download_pretrained_from_hf(
    model_id: str, filename: str = "open_clip_pytorch_model.bin", revision=None, cache_dir: Union[str, None] = None
):
    has_hf_hub(True)
