...
def freeze_batch_norm_2d(module, module_match={}, name=""):
    ...
    if is_match and isinstance(module, (paddle.nn.BatchNorm2D, paddle.nn.SyncBatchNorm)):
        ...
        for child_name, child in module.named_children():
            ...
            if new_child is not child:
                res.add_sublayer(name=child_name, sublayer=new_child)
    return res
...
def replace_linear(model, linear_replacement, include_modules=["c_fc", "c_proj"], copy_weights=True):
    for name, module in model.named_children():
        ...
        if isinstance(module, paddle.nn.Linear) and name in include_modules:
